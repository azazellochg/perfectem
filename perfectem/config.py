...
krios_falcon4 = {
    ...
    "InfoLimit": {"beam": 0.6, "spot": 3, "mag": 250000, "exp": 2, "binning": 1, "defocus": -0.5, "spec": 0.14},
    "ThonRings": {"beam": 0.6, "spot": 3, "mag": 250000, "exp": 1, "binning": 2, "defocus": -0.5, "spec": 0.33},  # Titan Krios G3i 195kx -2um defocus - spec is 0.33nm
    "GoldDiffr": {"beam": 1.05, "spot": 4, "mag": 600000, "exp": 3, "binning": 2, "defocus": -0.5, "spec": 0.1},  # For this test you need C2 150um and sample
